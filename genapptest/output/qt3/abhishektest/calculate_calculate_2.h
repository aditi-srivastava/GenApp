void abhishektest::module_load_calculate_calculate_2()
{
   ...
   }
   {
      ...
      { QString qs = "choice 1"; lb->insertItem( qs ); panel1_map_input[ QString( "lb:%1" ).arg( qs ) ] = "c1"; }{ QString qs = "choice 2"; lb->insertItem( qs ); panel1_map_input[ QString( "lb:%1" ).arg( qs ) ] = "c2"; }{ QString qs = "choice 3"; lb->insertItem( qs ); panel1_map_input[ QString( "lb:%1" ).arg( qs ) ] = "c3"; }{ QString qs = "choice 4"; lb->insertItem( qs ); panel1_map_input[ QString( "lb:%1" ).arg( qs ) ] = "c4"; }
   ...
   }
   {
      ...
      if ( !panel1_widget_map.count( "bg:output2" ) )
      {
         panel1_widget_map[ "bg:output2" ] = new QButtonGroup( 0 );
      }
...
void abhishektest::module_reset_calculate_calculate_2()
{
   reset_default_values();
}

void abhishektest::module_submit_calculate_calculate_2()
{
   save_last_values();
   ...
   QString program = "/home/abhishek/Desktop/GenApp/abhishektest/bin/calculate_2";
   ...
   process_calculate_calculate_2 = new QProcess( this );
   process_calculate_calculate_2->setWorkingDirectory( dir );
   process_calculate_calculate_2->addArgument( program );

   process_calculate_calculate_2->addArgument( input_to_json( "calculate_2", dir ) );
   connect( process_calculate_calculate_2, 
            SIGNAL( readyReadStdout() ), 
            this, 
            SLOT( readyReadStdout_calculate_calculate_2() ) );
   connect( process_calculate_calculate_2, 
            SIGNAL( readyReadStderr() ), 
            this, 
            SLOT( readyReadStderr_calculate_calculate_2() ) );
   connect( process_calculate_calculate_2, 
            SIGNAL( launchFinished() ), 
            this, 
            SLOT( launchFinished_calculate_calculate_2() ) );
   connect( process_calculate_calculate_2, 
            SIGNAL( processExited() ), 
            this, 
            SLOT( processExited_calculate_calculate_2() ) );
   if ( !process_calculate_calculate_2->start() )
   { 
...
void abhishektest::readyReadStdout_calculate_calculate_2()
{
   while ( process_calculate_calculate_2->canReadLineStdout() )
   {
      process_json[ "calculate_2" ] += process_calculate_calculate_2->readLineStdout();
   }
}

void abhishektest::readyReadStderr_calculate_calculate_2()
{
   while ( process_calculate_calculate_2->canReadLineStderr() )
   {
      qDebug( process_calculate_calculate_2->readLineStderr() );
   }
}

void abhishektest::launchFinished_calculate_calculate_2()
{
   // qDebug( "process_calculate_calculate_2->launchFinished()" );
   disconnect( process_calculate_calculate_2,
               SIGNAL( launchFinished_calculate_calculate_2() ),
               0, 0 );
}

void abhishektest::processExited_calculate_calculate_2()
{
   qDebug( "process_calculate_calculate_2->processExited()" );
   readyReadStdout_calculate_calculate_2();
   readyReadStderr_calculate_calculate_2();

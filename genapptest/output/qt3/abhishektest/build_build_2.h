void abhishektest::module_load_build_build_2()
{
   ...
   }
   {
      ...
      if ( !panel1_widget_map.count( "bg:input4" ) )
      {
         panel1_widget_map[ "bg:input4" ] = new QButtonGroup( 0 );
      }
      
      ((QButtonGroup *)panel1_widget_map[ "bg:input4" ])->insert( rb );
...
void abhishektest::module_submit_build_build_2()
{
   ...
   process_build_build_2->addArgument( program );

   process_build_build_2->addArgument( input_to_json( "build_2", dir ) );
   connect( process_build_build_2, 
            SIGNAL( readyReadStdout() ), 
            this, 
            SLOT( readyReadStdout_build_build_2() ) );
   connect( process_build_build_2, 
            SIGNAL( readyReadStderr() ), 
            this, 
            SLOT( readyReadStderr_build_build_2() ) );
   connect( process_build_build_2, 
            SIGNAL( launchFinished() ), 
            this, 
            SLOT( launchFinished_build_build_2() ) );
   connect( process_build_build_2, 
            SIGNAL( processExited() ), 
            this, 
            SLOT( processExited_build_build_2() ) );
   if ( !process_build_build_2->start() )
   { 
...
void abhishektest::readyReadStdout_build_build_2()
{
   while ( process_build_build_2->canReadLineStdout() )
   {
      process_json[ "build_2" ] += process_build_build_2->readLineStdout();
   }
}

void abhishektest::readyReadStderr_build_build_2()
{
   while ( process_build_build_2->canReadLineStderr() )
   {
      qDebug( process_build_build_2->readLineStderr() );
   }
}

void abhishektest::launchFinished_build_build_2()
{
   // qDebug( "process_build_build_2->launchFinished()" );
   disconnect( process_build_build_2,
               SIGNAL( launchFinished_build_build_2() ),
               0, 0 );
}

void abhishektest::processExited_build_build_2()
{
   qDebug( "process_build_build_2->processExited()" );
   readyReadStdout_build_build_2();
   readyReadStderr_build_build_2();

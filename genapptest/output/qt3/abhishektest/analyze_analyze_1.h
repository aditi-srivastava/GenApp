...
void abhishektest::module_submit_analyze_analyze_1()
{
   ...
   process_analyze_analyze_1->addArgument( program );

   process_analyze_analyze_1->addArgument( input_to_json( "analyze_1", dir ) );
   connect( process_analyze_analyze_1, 
            SIGNAL( readyReadStdout() ), 
            this, 
            SLOT( readyReadStdout_analyze_analyze_1() ) );
   connect( process_analyze_analyze_1, 
            SIGNAL( readyReadStderr() ), 
            this, 
            SLOT( readyReadStderr_analyze_analyze_1() ) );
   connect( process_analyze_analyze_1, 
            SIGNAL( launchFinished() ), 
            this, 
            SLOT( launchFinished_analyze_analyze_1() ) );
   connect( process_analyze_analyze_1, 
            SIGNAL( processExited() ), 
            this, 
            SLOT( processExited_analyze_analyze_1() ) );
   if ( !process_analyze_analyze_1->start() )
   { 
...
void abhishektest::readyReadStdout_analyze_analyze_1()
{
   while ( process_analyze_analyze_1->canReadLineStdout() )
   {
      process_json[ "analyze_1" ] += process_analyze_analyze_1->readLineStdout();
   }
}

void abhishektest::readyReadStderr_analyze_analyze_1()
{
   while ( process_analyze_analyze_1->canReadLineStderr() )
   {
      qDebug( process_analyze_analyze_1->readLineStderr() );
   }
}

void abhishektest::launchFinished_analyze_analyze_1()
{
   // qDebug( "process_analyze_analyze_1->launchFinished()" );
   disconnect( process_analyze_analyze_1,
               SIGNAL( launchFinished_analyze_analyze_1() ),
               0, 0 );
}

void abhishektest::processExited_analyze_analyze_1()
{
   qDebug( "process_analyze_analyze_1->processExited()" );
   readyReadStdout_analyze_analyze_1();
   readyReadStderr_analyze_analyze_1();

void abhishektest::module_load_simulate_simulate_1()
{
...
void abhishektest::module_reset_simulate_simulate_1()
{
   reset_default_values();
}

void abhishektest::module_submit_simulate_simulate_1()
{
   save_last_values();
   ...
   QString program = "/home/abhishek/Desktop/GenApp/abhishektest/bin/simulate_1";
   ...
   process_simulate_simulate_1 = new QProcess( this );
   process_simulate_simulate_1->setWorkingDirectory( dir );
   process_simulate_simulate_1->addArgument( program );

   process_simulate_simulate_1->addArgument( input_to_json( "simulate_1", dir ) );
   connect( process_simulate_simulate_1, 
            SIGNAL( readyReadStdout() ), 
            this, 
            SLOT( readyReadStdout_simulate_simulate_1() ) );
   connect( process_simulate_simulate_1, 
            SIGNAL( readyReadStderr() ), 
            this, 
            SLOT( readyReadStderr_simulate_simulate_1() ) );
   connect( process_simulate_simulate_1, 
            SIGNAL( launchFinished() ), 
            this, 
            SLOT( launchFinished_simulate_simulate_1() ) );
   connect( process_simulate_simulate_1, 
            SIGNAL( processExited() ), 
            this, 
            SLOT( processExited_simulate_simulate_1() ) );
   if ( !process_simulate_simulate_1->start() )
   { 
...
void abhishektest::readyReadStdout_simulate_simulate_1()
{
   while ( process_simulate_simulate_1->canReadLineStdout() )
   {
      process_json[ "simulate_1" ] += process_simulate_simulate_1->readLineStdout();
   }
}

void abhishektest::readyReadStderr_simulate_simulate_1()
{
   while ( process_simulate_simulate_1->canReadLineStderr() )
   {
      qDebug( process_simulate_simulate_1->readLineStderr() );
   }
}

void abhishektest::launchFinished_simulate_simulate_1()
{
   // qDebug( "process_simulate_simulate_1->launchFinished()" );
   disconnect( process_simulate_simulate_1,
               SIGNAL( launchFinished_simulate_simulate_1() ),
               0, 0 );
}

void abhishektest::processExited_simulate_simulate_1()
{
   qDebug( "process_simulate_simulate_1->processExited()" );
   readyReadStdout_simulate_simulate_1();
   readyReadStderr_simulate_simulate_1();

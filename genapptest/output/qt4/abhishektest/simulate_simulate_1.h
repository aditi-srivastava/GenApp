...
void abhishektest::module_submit_simulate_simulate_1()
{
   ...
   QStringList args;
   args << input_to_json( "simulate_1", dir );

   connect( process_simulate_simulate_1, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_simulate_simulate_1( QProcess::ProcessError ) ) );
   connect( process_simulate_simulate_1, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_simulate_simulate_1() ) );
   connect( process_simulate_simulate_1, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_simulate_simulate_1() ) );
   connect( process_simulate_simulate_1, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_simulate_simulate_1( int, QProcess::ExitStatus ) ) );
   process_simulate_simulate_1->start( program, args );
   process_json[ "simulate_1" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_simulate_simulate_1()
{
   process_json[ "simulate_1" ] += QString( process_simulate_simulate_1->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_simulate_simulate_1()
{
   qDebug() << process_simulate_simulate_1->readAllStandardError();
}

void abhishektest::error_simulate_simulate_1( QProcess::ProcessError e )
{
   qDebug() << "process_simulate_simulate_1->error()" << e;
}

void abhishektest::finished_simulate_simulate_1( int, QProcess::ExitStatus )
{

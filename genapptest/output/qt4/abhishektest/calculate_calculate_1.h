void abhishektest::module_load_calculate_calculate_1()
{
...
void abhishektest::module_reset_calculate_calculate_1()
{
   reset_default_values();
}

void abhishektest::module_submit_calculate_calculate_1()
{
   save_last_values();
   ...
   QString program = "/home/abhishek/Desktop/GenApp/abhishektest/bin/calculate_1";
   ...
   QStringList args;
   args << input_to_json( "calculate_1", dir );

   connect( process_calculate_calculate_1, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_calculate_calculate_1( QProcess::ProcessError ) ) );
   connect( process_calculate_calculate_1, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_calculate_calculate_1() ) );
   connect( process_calculate_calculate_1, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_calculate_calculate_1() ) );
   connect( process_calculate_calculate_1, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_calculate_calculate_1( int, QProcess::ExitStatus ) ) );
   process_calculate_calculate_1->start( program, args );
   process_json[ "calculate_1" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_calculate_calculate_1()
{
   process_json[ "calculate_1" ] += QString( process_calculate_calculate_1->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_calculate_calculate_1()
{
   qDebug() << process_calculate_calculate_1->readAllStandardError();
}

void abhishektest::error_calculate_calculate_1( QProcess::ProcessError e )
{
   qDebug() << "process_calculate_calculate_1->error()" << e;
}

void abhishektest::finished_calculate_calculate_1( int, QProcess::ExitStatus )
{

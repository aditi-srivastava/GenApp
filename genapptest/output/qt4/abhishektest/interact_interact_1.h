...
void abhishektest::module_submit_interact_interact_1()
{
   ...
   QStringList args;
   args << input_to_json( "interact_1", dir );

   connect( process_interact_interact_1, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_interact_interact_1( QProcess::ProcessError ) ) );
   connect( process_interact_interact_1, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_interact_interact_1() ) );
   connect( process_interact_interact_1, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_interact_interact_1() ) );
   connect( process_interact_interact_1, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_interact_interact_1( int, QProcess::ExitStatus ) ) );
   process_interact_interact_1->start( program, args );
   process_json[ "interact_1" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_interact_interact_1()
{
   process_json[ "interact_1" ] += QString( process_interact_interact_1->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_interact_interact_1()
{
   qDebug() << process_interact_interact_1->readAllStandardError();
}

void abhishektest::error_interact_interact_1( QProcess::ProcessError e )
{
   qDebug() << "process_interact_interact_1->error()" << e;
}

void abhishektest::finished_interact_interact_1( int, QProcess::ExitStatus )
{

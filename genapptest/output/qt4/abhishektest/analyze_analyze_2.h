...
void abhishektest::module_submit_analyze_analyze_2()
{
   ...
   QStringList args;
   args << input_to_json( "analyze_2", dir );

   connect( process_analyze_analyze_2, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_analyze_analyze_2( QProcess::ProcessError ) ) );
   connect( process_analyze_analyze_2, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_analyze_analyze_2() ) );
   connect( process_analyze_analyze_2, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_analyze_analyze_2() ) );
   connect( process_analyze_analyze_2, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_analyze_analyze_2( int, QProcess::ExitStatus ) ) );
   process_analyze_analyze_2->start( program, args );
   process_json[ "analyze_2" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_analyze_analyze_2()
{
   process_json[ "analyze_2" ] += QString( process_analyze_analyze_2->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_analyze_analyze_2()
{
   qDebug() << process_analyze_analyze_2->readAllStandardError();
}

void abhishektest::error_analyze_analyze_2( QProcess::ProcessError e )
{
   qDebug() << "process_analyze_analyze_2->error()" << e;
}

void abhishektest::finished_analyze_analyze_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_analyze_analyze_2->finished()";
   readyReadStandardOutput_analyze_analyze_2();
   readyReadStandardError_analyze_analyze_2();

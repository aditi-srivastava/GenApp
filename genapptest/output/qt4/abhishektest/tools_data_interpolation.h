...
void abhishektest::module_submit_tools_data_interpolation()
{
   ...
   QStringList args;
   args << input_to_json( "data_interpolation", dir );

   connect( process_tools_data_interpolation, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_tools_data_interpolation( QProcess::ProcessError ) ) );
   connect( process_tools_data_interpolation, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_tools_data_interpolation() ) );
   connect( process_tools_data_interpolation, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_tools_data_interpolation() ) );
   connect( process_tools_data_interpolation, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_tools_data_interpolation( int, QProcess::ExitStatus ) ) );
   process_tools_data_interpolation->start( program, args );
   process_json[ "data_interpolation" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_tools_data_interpolation()
{
   process_json[ "data_interpolation" ] += QString( process_tools_data_interpolation->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_tools_data_interpolation()
{
   qDebug() << process_tools_data_interpolation->readAllStandardError();
}

void abhishektest::error_tools_data_interpolation( QProcess::ProcessError e )
{
   qDebug() << "process_tools_data_interpolation->error()" << e;
}

void abhishektest::finished_tools_data_interpolation( int, QProcess::ExitStatus )
{

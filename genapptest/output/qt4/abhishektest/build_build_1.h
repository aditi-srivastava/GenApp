void abhishektest::module_load_build_build_1()
{
...
void abhishektest::module_reset_build_build_1()
{
   reset_default_values();
}

void abhishektest::module_submit_build_build_1()
{
   save_last_values();
   ...
   QString program = "/home/abhishek/Desktop/GenApp/abhishektest/bin/build_1";
   ...
   QStringList args;
   args << input_to_json( "build_1", dir );

   connect( process_build_build_1, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_build_build_1( QProcess::ProcessError ) ) );
   connect( process_build_build_1, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_build_build_1() ) );
   connect( process_build_build_1, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_build_build_1() ) );
   connect( process_build_build_1, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_build_build_1( int, QProcess::ExitStatus ) ) );
   process_build_build_1->start( program, args );
   process_json[ "build_1" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_build_build_1()
{
   process_json[ "build_1" ] += QString( process_build_build_1->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_build_build_1()
{
   qDebug() << process_build_build_1->readAllStandardError();
}

void abhishektest::error_build_build_1( QProcess::ProcessError e )
{
   qDebug() << "process_build_build_1->error()" << e;
}

void abhishektest::finished_build_build_1( int, QProcess::ExitStatus )
{
   qDebug() << "process_build_build_1->finished()";
   readyReadStandardOutput_build_build_1();
   readyReadStandardError_build_build_1();

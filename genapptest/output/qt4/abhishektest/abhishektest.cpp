...
{
   {
      QFile sf( "abhishektest/style.qss" );
...
void abhishektest::hide_widgets( QVector < QWidget * > &widgets, bool hide )
{
...
void abhishektest::delete_widgets_layouts( QVector < QWidget * > &widgets, 

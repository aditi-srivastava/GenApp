...
class abhishektest : public QFrame
{
   ...
   private slots:
      ...
      void                          error_tools_test( QProcess::ProcessError );
      void                          readyReadStandardOutput_tools_test();
      void                          readyReadStandardError_tools_test();
      void                          finished_tools_test( int, QProcess::ExitStatus );
   ...
   private slots:
      ...
      void                          error_interact_interact_2( QProcess::ProcessError );
      void                          readyReadStandardOutput_interact_interact_2();
      void                          readyReadStandardError_interact_interact_2();
      void                          finished_interact_interact_2( int, QProcess::ExitStatus );
   ...
   private slots:
      ...
      void                          error_analyze_analyze_1( QProcess::ProcessError );
      void                          readyReadStandardOutput_analyze_analyze_1();
      void                          readyReadStandardError_analyze_analyze_1();
      void                          finished_analyze_analyze_1( int, QProcess::ExitStatus );
   ...
   private slots:
      ...
      void                          error_analyze_analyze_2( QProcess::ProcessError );
      void                          readyReadStandardOutput_analyze_analyze_2();
      void                          readyReadStandardError_analyze_analyze_2();
      void                          finished_analyze_analyze_2( int, QProcess::ExitStatus );

...
void abhishektest::module_submit_interact_interact_2()
{
   ...
   QStringList args;
   args << input_to_json( "interact_2", dir );

   connect( process_interact_interact_2, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_interact_interact_2( QProcess::ProcessError ) ) );
   connect( process_interact_interact_2, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_interact_interact_2() ) );
   connect( process_interact_interact_2, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_interact_interact_2() ) );
   connect( process_interact_interact_2, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_interact_interact_2( int, QProcess::ExitStatus ) ) );
   process_interact_interact_2->start( program, args );
   process_json[ "interact_2" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_interact_interact_2()
{
   process_json[ "interact_2" ] += QString( process_interact_interact_2->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_interact_interact_2()
{
   qDebug() << process_interact_interact_2->readAllStandardError();
}

void abhishektest::error_interact_interact_2( QProcess::ProcessError e )
{
   qDebug() << "process_interact_interact_2->error()" << e;
}

void abhishektest::finished_interact_interact_2( int, QProcess::ExitStatus )
{
   qDebug() << "process_interact_interact_2->finished()";
   readyReadStandardOutput_interact_interact_2();
   readyReadStandardError_interact_interact_2();

...
void abhishektest::module_submit_tools_align()
{
   ...
   QStringList args;
   args << input_to_json( "align", dir );

   connect( process_tools_align, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_tools_align( QProcess::ProcessError ) ) );
   connect( process_tools_align, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_tools_align() ) );
   connect( process_tools_align, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_tools_align() ) );
   connect( process_tools_align, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_tools_align( int, QProcess::ExitStatus ) ) );
   process_tools_align->start( program, args );
   process_json[ "align" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_tools_align()
{
   process_json[ "align" ] += QString( process_tools_align->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_tools_align()
{
   qDebug() << process_tools_align->readAllStandardError();
}

void abhishektest::error_tools_align( QProcess::ProcessError e )
{
   qDebug() << "process_tools_align->error()" << e;
}

void abhishektest::finished_tools_align( int, QProcess::ExitStatus )
{

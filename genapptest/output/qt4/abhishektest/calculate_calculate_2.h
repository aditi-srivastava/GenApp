...
void abhishektest::module_submit_calculate_calculate_2()
{
   ...
   QStringList args;
   args << input_to_json( "calculate_2", dir );

   connect( process_calculate_calculate_2, 
            SIGNAL( error( QProcess::ProcessError ) ), 
            this, 
            SLOT( error_calculate_calculate_2( QProcess::ProcessError ) ) );
   connect( process_calculate_calculate_2, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardOutput_calculate_calculate_2() ) );
   connect( process_calculate_calculate_2, 
            SIGNAL( readyReadStandardOutput() ), 
            this, 
            SLOT( readyReadStandardError_calculate_calculate_2() ) );
   connect( process_calculate_calculate_2, 
            SIGNAL( finished( int, QProcess::ExitStatus ) ), 
            this, 
            SLOT( finished_calculate_calculate_2( int, QProcess::ExitStatus ) ) );
   process_calculate_calculate_2->start( program, args );
   process_json[ "calculate_2" ] = "";
   qDebug() << "process started";
}

void abhishektest::readyReadStandardOutput_calculate_calculate_2()
{
   process_json[ "calculate_2" ] += QString( process_calculate_calculate_2->readAllStandardOutput() );
}

void abhishektest::readyReadStandardError_calculate_calculate_2()
{
   qDebug() << process_calculate_calculate_2->readAllStandardError();
}

void abhishektest::error_calculate_calculate_2( QProcess::ProcessError e )
{
   qDebug() << "process_calculate_calculate_2->error()" << e;
}

void abhishektest::finished_calculate_calculate_2( int, QProcess::ExitStatus )
{

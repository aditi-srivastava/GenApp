...
if ( !sizeof( $_REQUEST ) )
{
    ...
    error_mail( $msg . "Error occured in calculate calculate_2.\n" );
...
$cmd = isset( $_REQUEST[ '_docrootexecutable' ] ) ? "/var/www/html/abhishektest/" . $_REQUEST[ '_docrootexecutable' ] : "/home/abhishek/Desktop/GenApp/abhishektest/bin/calculate_2";
...
$GLOBALS[ 'module'  ] = "calculate_2";
$GLOBALS[ 'menu'    ] = "calculate";
...
$adir = "/var/www/html/abhishektest";

if ( !isset( $uniquedir ) &&
     isset( $_SESSION[ $window ][ 'logon' ] ) &&
     strlen( $_SESSION[ $window ][ 'logon' ] ) > 1 )
{
   $dir = "/var/www/html/abhishektest/results/users/" . $_SESSION[ $window ][ 'logon' ] . "/";
   $bdir = $dir;
...
// connect
   ...
   {
      db_connect( true );
      $coll = $use_db->abhishektest->joblock;
   ...
   do {
       $dir = uniqid( "/var/www/html/abhishektest/results/" );
...
if ( sizeof( $_REQUEST ) )
{
    ...
    if ( isset( $fileargs ) )
    {
      ...
      if($cmdprefix == "airavatarun"){ 
        ...
        $register = "perl $adir/util/ga_regpid_udp.pl abhishektest " . 
        $GLOBALS['resource'] . " " . 
        $_REQUEST[ '_udphost' ] . " " .
        $_REQUEST[ '_udpport' ] . " " .
        $_REQUEST[ '_uuid' ] . " " .
...
//    error_log( "\tcmd: <$cmd>\n", 3, "/tmp/mylog" );
    ...
    $altcmd = "nohup /usr/local/bin/php /var/www/html/abhishektest/util/jobrun.php " . $GLOBALS[ 'logon' ] . " " . $_REQUEST[ '_uuid' ] . " " . ( isset( $checkrunning ) ? "1" : "0" ) . " 2>&1 >> /tmp/php_errors &";

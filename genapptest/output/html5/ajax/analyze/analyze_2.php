...
if ( !sizeof( $_REQUEST ) )
{
    ...
    error_mail( $msg . "Error occured in analyze analyze_2.\n" );
...
$cmd = isset( $_REQUEST[ '_docrootexecutable' ] ) ? "/var/www/html/abhishektest/" . $_REQUEST[ '_docrootexecutable' ] : "/home/abhishek/Desktop/GenApp/abhishektest/bin/analyze_2";
...
$GLOBALS[ 'module'  ] = "analyze_2";
$GLOBALS[ 'menu'    ] = "analyze";

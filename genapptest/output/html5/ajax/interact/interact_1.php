...
if ( !sizeof( $_REQUEST ) )
{
    ...
    error_mail( $msg . "Error occured in interact interact_1.\n" );
...
$cmd = isset( $_REQUEST[ '_docrootexecutable' ] ) ? "/var/www/html/abhishektest/" . $_REQUEST[ '_docrootexecutable' ] : "/home/abhishek/Desktop/GenApp/abhishektest/bin/interact_1";
...
$GLOBALS[ 'module'  ] = "interact_1";
$GLOBALS[ 'menu'    ] = "interact";

...
if ( !sizeof( $_REQUEST ) )
{
    ...
    error_mail( $msg . "Error occured in tools test.\n" );
...
$cmd = isset( $_REQUEST[ '_docrootexecutable' ] ) ? "/var/www/html/abhishektest/" . $_REQUEST[ '_docrootexecutable' ] : "/home/abhishek/Desktop/GenApp/abhishektest/bin/test";

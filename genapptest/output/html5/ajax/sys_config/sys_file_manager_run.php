...
$dir     = "/var/www/html/abhishektest/$userdir";
...
$pkgname = "abhishektest_${logon}_" . date( "YmdHisT", time() );
...
$result[ 'outfiles' ] = array( str_replace( "/var/www/html/abhishektest/", "", $target ) );
